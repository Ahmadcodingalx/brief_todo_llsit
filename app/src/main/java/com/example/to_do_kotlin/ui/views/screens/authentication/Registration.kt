package com.example.to_do_kotlin.ui.Views.screens.authentication
...
import com.example.to_do_kotlin.ui.views.layout.BackTopAppBar
import com.example.to_do_kotlin.R
import com.example.to_do_kotlin.data.room.models.User
import com.example.to_do_kotlin.ui.Views.AuthRouteScreens

import com.example.to_do_kotlin.ui.components.DefaultCheckBox
import com.example.to_do_kotlin.ui.components.DefaultTextField
import com.example.to_do_kotlin.utils.StringConstants
import com.example.to_do_kotlin.utils.emailLengthValidation
import com.example.to_do_kotlin.utils.fullNameLengthValidation
import com.example.to_do_kotlin.utils.passwordLenthValidation
import com.example.to_do_kotlin.viewmodels.AuthViewModel
import kotlinx.coroutines.launch
import com.example.to_do_kotlin.ui.theme.ToDoListBriefTheme
                                    ...
                                    if (!isTermsAccepted){
                                        ...
                                        if (authState.usersList.isNotEmpty()){
                                            ...
                                            authViewModel.sendOTPCode(
                                                com.example.to_do_kotlin.data.room.models.OTPCode(
                                                    email = email,
